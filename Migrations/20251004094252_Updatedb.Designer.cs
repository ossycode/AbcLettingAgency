...
namespace AbcLettingAgency.Migrations
{
    ...
    [Migration("20251004094252_Updatedb")]
            ...
            modelBuilder.Entity("AbcLettingAgency.EntityModel.Agencies.Agency", b =>
                {
                    ...
                    b.OwnsOne("AbcLettingAgency.EntityModel.Agencies.AgencySettings", "Settings", b1 =>
                        {
                            b1.Property<long>("AgencyId")
                                .HasColumnType("bigint");

                            b1.Property<int>("ArrearsEmailDays")
                                .HasColumnType("integer");

                            b1.Property<decimal?>("DefaultCommissionPercent")
                                .HasPrecision(18, 2)
                                .HasColumnType("numeric(18,2)");

                            b1.Property<int>("DefaultRentDueDay")
                                .HasColumnType("integer");

                            b1.Property<string>("DefaultRentFrequency")
                                .IsRequired()
                                .HasMaxLength(32)
                                .HasColumnType("character varying(32)");

                            b1.Property<bool>("EnableArrearsEmails")
                                .HasColumnType("boolean");

                            b1.Property<Dictionary<string, string>>("FeatureFlags")
                    ...
                    b.OwnsOne("AbcLettingAgency.EntityModel.Agencies.Branding", "Branding", b1 =>
                        {
                            b1.Property<long>("AgencyId")
                                .HasColumnType("bigint");

                            b1.Property<string>("LogoBlobId")
                                .HasMaxLength(200)
                                .HasColumnType("character varying(200)")
                                .HasColumnName("Branding_LogoBlobId");

                            b1.Property<string>("PrimaryColorHex")
                                .HasMaxLength(7)
                                .HasColumnType("character varying(7)")
                                .HasColumnName("Branding_PrimaryColor");

                            b1.Property<string>("SecondaryColorHex")
                                .HasMaxLength(7)
                                .HasColumnType("character varying(7)")
                                .HasColumnName("Branding_SecondaryColor");
